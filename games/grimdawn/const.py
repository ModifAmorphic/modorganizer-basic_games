...
class GD():
    ...
    def _set_paths(self):
        self._game_db_paths = [ 
            self._game_dir.joinpath(db)
            for db in GD.GAME_DATABASES
        ]
        ...
        self._game_resources_extract_path = self._game_extract_path.joinpath("resources")
        self._mods_extract_path = self._root_extract_dir.joinpath("mods")

    def GAME_DIRECTORY(self): return self._game_dir
    def GAME_DATABASE_PATHS(self): return self._game_db_paths
    def GAME_ROOT_EXTRACT_PATH(self): return self._root_extract_dir
    def GAME_DATA_EXTRACT_PATH(self): return self._game_extract_path
    def GAME_DB_EXTRACT_PATH(self): return self._game_db_extract_path
    def GAME_RESOURCES_EXTRACT_PATH(self): return self._game_resources_extract_path
    def MODS_DATA_EXTRACT_PATH(self): return self._mods_extract_path